...
#import "ProfileEmergencyContact.h"

#define ACCEPTABLE_CHARACTERS @"0123456789"
@interface EmergencyViewController ()<kDropDownListViewDelegate,UrlConnectionDelegate,DatePickerViewDelegate>
...
- (void)viewDidLoad
{
    ...
    [self setTitle:@"Emergency Contact"];
...
-(void)drawUI
{
    float yy=20.0f;
    int tagValue=0;
    NSMutableArray *labelArray=[[NSMutableArray alloc]initWithObjects:@"First Name",@"Last Name",@"Middle Name",@"Date Of Birth",@"Gender",@"Address1",@"Address2",@"City",@"ZipCode",@"Country",@"state",@"Phone",@"Email",nil];
    ...
    for(NSString *str in labelArray)
    {
        ...
        if(tagValue>8 || tagValue==0 || tagValue==1)//These are mendatory Field
        {
        ...
        else if (tagValue==10 ||tagValue==9||tagValue==4)
        {
...
-(void)setUpTextField
{
    ...
    ProfileEmergencyContact *emergencyContact=profileInfo.relationProfileEmergency;
    if(emergencyContact)
    {
        for(UITextField *textField in allTextFieldArray)
        {
            ...
            {
                case 0:
                    textField.text=emergencyContact.firstName;
                    break;
                    
                case 1:
                    textField.text=emergencyContact.lastName;
                    break;
                    
                case 2:
                    textField.text=emergencyContact.middleName;
                    break;
                    
                case 3:
                    textField.text=emergencyContact.date_of_birth;
                    break;
                    
                case 4:
                    textField.text=emergencyContact.gender;
                    break;
                    
                case 5:
                    textField.text=emergencyContact.address1;
                    break;
                    
                case 6:
                    textField.text=emergencyContact.address2;
                    break;
                    
                case 7:
                    textField.text=emergencyContact.city;
                    break;
                    
                case 8:
                    textField.text=emergencyContact.zipCode;
                    break;
                    
                case 10:
                    textField.text=emergencyContact.state;
                    provinceCode=emergencyContact.provinceCode;
                    break;
                    
                case 9:
                    textField.text=emergencyContact.country;
                    countryCode=emergencyContact.countryCode;
                    break;
                    
                case 11:
                    textField.text=emergencyContact.phone;
                    break;
                    
                case 12:
                    textField.text=emergencyContact.email;
                    break;
...
-(void)saveDataToLocal
{
    ...
    {
        emergencyContact=[NSEntityDescription insertNewObjectForEntityForName:AmgineEmergencyProfileContact inManagedObjectContext:[[Data sharedData]getContext]];
    }
    for(UITextField *textField in allTextFieldArray)
    {
        switch (textField.tag)
        {
            case 0:
                emergencyContact.firstName=textField.text;
            break;
                
            case 1:
                emergencyContact.lastName=textField.text;
            break;
                
            case 2:
                emergencyContact.middleName=textField.text;
            break;
                
            case 3:
                emergencyContact.date_of_birth=textField.text;
            break;
                
            case 4:
                emergencyContact.gender=textField.text;
            break;
                
            case 5:
                emergencyContact.address1= textField.text;
            break;
                
            case 6:
                emergencyContact.address2= textField.text;
            break;
                
            case 7:
                emergencyContact.city=textField.text;
            break;
                
            case 8:
                emergencyContact.zipCode=textField.text;
            break;
                
            case 10:
                emergencyContact.state=textField.text;
                emergencyContact.provinceCode= provinceCode;
            break;
                
            case 9:
                emergencyContact.country=textField.text;
                emergencyContact.countryCode=countryCode;
            break;
                
            case 11:
                emergencyContact.phone=textField.text;
            break;
                
            case 12:
                emergencyContact.email=textField.text;
            break;
                
            }
    }
    profileInfo.relationProfileEmergency=emergencyContact;
