...
@interface PaymentHistoryViewController ()<UIScrollViewDelegate>
...
-(void)drawUI
{
    float yy=20.0f;
    int tagValue=0;
    NSMutableArray *labelArray=[[NSMutableArray alloc]initWithObjects:@"Unique Identifier",@"Date",@"Trip details",@"Cost of Trip",@"Partial Payment List with dates",@"Payment Type ",@"Payment Received",nil];
